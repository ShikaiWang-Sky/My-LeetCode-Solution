...
//Java：栈的压入、弹出序列
public class Offer31ZhanDeYaRuDanChuXuLieLcof {
    public static void main(String[] args) {
        Solution solution = new Offer31ZhanDeYaRuDanChuXuLieLcof().new Solution();
        // TO TEST
        int[] pushed = {1, 2, 3, 4, 5}, popped = {4, 5, 3, 2, 1};
        System.out.println(solution.validateStackSequences(pushed,
                popped));
    }
