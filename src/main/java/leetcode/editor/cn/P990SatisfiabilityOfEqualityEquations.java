...
public class P990SatisfiabilityOfEqualityEquations {
    public static void main(String[] args) {
        ...
        // TO TEST
        String[] equation = {"a!=b","b!=c","c!=a"};
        solution.equationsPossible(equation);
    }
    ...
    class Solution {
        ...
        public boolean equationsPossible(String[] equations) {
            ...
            unionFindSet.init(26);
            for (String equation : equations) {
                char c1 = equation.charAt(0);
                char c2 = equation.charAt(3);
                if (equation.charAt(1) == '=') {
                    unionFindSet.union(c1 - 'a', c2 - 'a');
                }
            }
            for (String equation : equations) {
                char c1 = equation.charAt(0);
                char c2 = equation.charAt(3);
                if (equation.charAt(1) == '!' && unionFindSet.find(c1 - 'a') == unionFindSet.find( c2 - 'a'))
                    return false;
            }
            return true;
        }
